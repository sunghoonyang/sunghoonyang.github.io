...
setup(
    name='sunghoonyang.github.io',
    version='1.0',
    packages=['venv.lib.python3.7.site-packages.bs4', 'venv.lib.python3.7.site-packages.bs4.tests',
              'venv.lib.python3.7.site-packages.bs4.builder', 'venv.lib.python3.7.site-packages.yaml',
              'venv.lib.python3.7.site-packages.click', 'venv.lib.python3.7.site-packages.flask',
              'venv.lib.python3.7.site-packages.flask.json', 'venv.lib.python3.7.site-packages.jinja2',
              'venv.lib.python3.7.site-packages.cssutils', 'venv.lib.python3.7.site-packages.cssutils.css',
              'venv.lib.python3.7.site-packages.cssutils.tests',
              'venv.lib.python3.7.site-packages.cssutils.tests.test_encutils',
              'venv.lib.python3.7.site-packages.cssutils.scripts',
              'venv.lib.python3.7.site-packages.cssutils.stylesheets', 'venv.lib.python3.7.site-packages.encutils',
              'venv.lib.python3.7.site-packages.markdown', 'venv.lib.python3.7.site-packages.markdown.extensions',
              'venv.lib.python3.7.site-packages.werkzeug', 'venv.lib.python3.7.site-packages.werkzeug.debug',
              'venv.lib.python3.7.site-packages.werkzeug.contrib', 'venv.lib.python3.7.site-packages.markupsafe',
              'venv.lib.python3.7.site-packages.flask_frozen', 'venv.lib.python3.7.site-packages.flask_frozen.test_app',
              'venv.lib.python3.7.site-packages.flask_frozen.test_app.admin',
              'venv.lib.python3.7.site-packages.flask_flatpages',
    ...
    author='sunghoonyang',
    author_email='',
    description='my website hosted statically in github.io'
)
